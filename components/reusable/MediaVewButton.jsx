...
function MediaViewButton ({
  ...
  return (
    <div
      className={`flex gap-2 lg:gap-4 rounded-full justify-between items-center px-2 py-3 sm:px-2 sm:py-2 md:px-1 md:py-1 lg:px-2 lg:py-2 2xl:px-4 2xl:py-4 w-fit w-[95%]`}
      style={{
