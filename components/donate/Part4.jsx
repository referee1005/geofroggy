...
function Faqs ({ title, data }) {
  ...
  return (
    <div
      className='container-custom py-24 flex flex-col'
      style={{ backgroundColor: '#D9D9D9' }}
    >
      <div className='text-3xl lg:text-4xl xl:text-5xl 3xl:text-6xl text-center mb-4 font-medium'>
        Frequently asked questions
      </div>
      <div className='text-sm text-center md:text-lg xl:text-xl 3xl:text-2xl w-full text-center mb-16'>
        Have another questions? Email at <span>ask@geofroggy.com</span>
      </div>
      <div className='sm:flex-1 mx-[5%] sm:mx-[15%]'>
        {data &&
          data.map((item, index) => {
            return (
              <div
