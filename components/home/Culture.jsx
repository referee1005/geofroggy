...
function Culture ({}) {
  return (
    <div className='relative  sm:min-h-120'>
      ...
      <div className=''>
        <div className='container-custom absolute inset-0 md:mx-16 lg:mx-0 lg:flex my-12 lg:my-24 2xl:my-24 3xl:my-36'>
          <div className='w-full lg:w-1/2 lg:grid lg:grid-cols-3 gap-4 flex justify-between'>
            <Image
              src={Culture1}
              alt='Culture'
              className='h-36 ms:h-48 sm:h-56 w-auto ml:h-64 lg:h-60 xl:h-72 2xl:h-80 3xl:h-96'
            />
            <Image
              src={Culture2}
              alt='Culture'
          ...
          <div className='flex flex-col items-center mx-8 my-4 lg:my-4 lg:block'>
